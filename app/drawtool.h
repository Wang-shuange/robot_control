...
public:
    ...
    void constraint4servo(DrawScene * scene);
};
...
public:
    ...
    void draw_bezier(DrawScene *scene);
    void draw_polyline(DrawScene *scene);
    void draw_line(DrawScene *scene);
public slots:
    void simple_draw_line(DrawScene *scene, QVector<QPointF> &v);
    void simple_draw_polyline(DrawScene *scene, QVector<QPointF> &v);
};
